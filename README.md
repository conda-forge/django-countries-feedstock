About django-countries-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-countries-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-countries-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-countries
# for installing globally
pixi global install django-countries
```
...
It is possible to list all of the versions of `django-countries` available on your platform:
...
```
pixi search django-countries --channel conda-forge
```
