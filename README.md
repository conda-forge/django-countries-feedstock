...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-countries-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15123&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-countries-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-countries` can be installed with:

```
conda install django-countries
```

It is possible to list all of the versions of `django-countries` available on your platform with:
